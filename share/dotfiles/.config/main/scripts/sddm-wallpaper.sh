...
sddm_theme_tpl="/usr/share/main-hyprland/sddm/theme.conf"
if [ -f $HOME/.config/main/settings/sddm/theme.conf ]; then
    sddm_theme_tpl="$HOME/.config/main/settings/sddm/theme.conf"
...
sudo cp /usr/share/main-hyprland/sddm/sddm.conf /etc/sddm.conf.d/
