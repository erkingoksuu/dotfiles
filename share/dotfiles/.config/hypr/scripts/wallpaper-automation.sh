...
sec=$(cat ~/.config/main/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/main/cache/wallpaper-automation ] ;then
    touch ~/.config/main/cache/wallpaper-automation
    ...
    rm ~/.config/main/cache/wallpaper-automation
